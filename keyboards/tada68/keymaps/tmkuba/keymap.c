...
[_FL] = LAYOUT_ansi(
  ...
  _______,_______,_______,_______,_______, _______,_______,_______,_______,_______,_______,_______,_______, _______,KC_AUDIO_MUTE, \
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,        _______,KC_AUDIO_VOL_UP, \
  _______,_______,_______,_______, _______,_______, _______,BL_TOGG,BL_DEC,BL_INC,_______,_______, KC_PGUP, KC_AUDIO_VOL_DOWN, \
